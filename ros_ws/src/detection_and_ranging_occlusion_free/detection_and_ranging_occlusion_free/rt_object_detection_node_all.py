...
# momento in uso il modello dello sweep W&B (Dataset Esteso ottimizzato,
# il migliore per mAP50-95, vedi capitolo modelli di visione) -- per
# tornare a un altro modello commentare/scommentare la riga giusta tra
